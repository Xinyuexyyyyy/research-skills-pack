...
| 选导师 | **supervisor-scout** | 导师调研与背调（保研/考研）|

### 第二层 · 任务执行层（4）— 把活拆开、推进、收尾

| Skill | 一句话 |
|---|---|
| **task-analyze** | 任何新需求的初步理解 |
| **task-decompose** | 确认需拆解后，最多 5 子任务 |
...
| Skill | 一句话 |
|---|---|
| **output-layer** | 公共输出层（Markdown / PDF / Obsidian / PPT 渲染）|
